...
* [OpenClaw](https://github.com/openclaw/openclaw) ⭐ 390,277 | 🐛 8,289 | 🌐 TypeScript | 📅 2026-09-23 – Self-hosted AI assistant that connects Claude to Telegram (and 7 other channels) from a single deployment. Supports hooks, plugins, and tools. Telegram setup: <https://clawdbot.blog/channels/telegram/>
* [TikTok Live Recorder | TikRec](https://t.me/tikrec_live_bot) – [Open Source](https://github.com/Michele0303/tiktok-live-recorder) ⭐ 910 | 🐛 138 | 🌐 Python | 📅 2026-08-12 bot that records TikTok live streams and delivers the MP4 to your Telegram chat. Free, with a public archive at [tikrec.com](https://tikrec.com).
* [Aeon](https://github.com/aeonfun/aeon) ⭐ 754 | 🐛 2 | 🌐 Shell | 📅 2026-09-22 – [Open Source](https://github.com/aeonfun/aeon) ⭐ 754 | 🐛 2 | 🌐 Shell | 📅 2026-09-22 autonomous AI agent framework, self-hosted under MIT, that reports to Telegram with interactive inline buttons and inbound command routing via webhook and long-polling.
...
* [python-telegram-bot](https://github.com/python-telegram-bot/python-telegram-bot) ⭐ 29,490 | 🐛 29 | 🌐 Python | 📅 2026-09-22 – We have made you a wrapper you can't refuse
...
* [AIOGram](https://github.com/aiogram/aiogram) ⭐ 5,868 | 🐛 84 | 🌐 Python | 📅 2026-09-19 – A pretty simple and fully asynchronous framework for Telegram Bot API.
...
* [grammY](https://github.com/grammyjs/grammY) ⭐ 3,751 | 🐛 26 | 🌐 TypeScript | 📅 2026-08-26 – The Telegram Bot Framework. (JavaScript, Typescript, Node.js)
...
* [WTelegramClient](https://github.com/wiz0u/WTelegramClient/) ⭐ 1,321 | 🐛 0 | 🌐 C# | 📅 2026-08-18 – Telegram Client API (MTProto) library written 100% in C# and .NET Standard
...
* [MadeLineProto](https://github.com/danog/MadelineProto) ⭐ 3,519 | 🐛 75 | 🌐 PHP | 📅 2026-09-22 – Async PHP client/server API for the telegram MTProto protocol.
* [telegram-bot-sdk](https://github.com/irazasyed/telegram-bot-sdk) ⭐ 3,300 | 🐛 29 | 🌐 PHP | 📅 2026-08-20 – Telegram Bot API PHP SDK. Lets you build Telegram Bots easily! Supports Laravel out of the box
...
* [TelegramBots](https://github.com/rubenlagus/TelegramBots) ⭐ 5,514 | 🐛 196 | 🌐 Java | 📅 2026-09-07 – Java library to create bots using Telegram Bots API.
...
* [TelegramCode](https://github.com/olosegres/telegramcode) ⭐ 6 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-22 – Self-hosted bot to run OpenCode and Claude Code coding agents on your machine or VPS and drive them from Telegram by voice or text, one topic per project.
...
* [Telegram Bot API](https://github.com/OasisPioneer/Telegram-Bot-API) ⭐ 0 | 🐛 0 | 🌐 C++ | 📅 2026-09-23 – Modern C++17 library for the Telegram Bot API.
...
* [KtGram](https://github.com/vendelieu/telegram-bot) ⭐ 249 | 🐛 5 | 🌐 Kotlin | 📅 2026-09-22 – Telegram Bot API wrapper with handy Kotlin DSL.
...
* [Telegram-Archive](https://github.com/GeiserX/Telegram-Archive) ⭐ 209 | 🐛 4 | 🌐 Python | 📅 2026-09-22 – Docker-based tool for archiving Telegram channels and groups with full media support, incremental backups, and a local web viewer.
...
* [Jellyfin Telegram Channel Sync](https://github.com/GeiserX/jellyfin-telegram-channel-sync) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-09-22 – Syncs Jellyfin user access with Telegram channel membership.
...
* [telegram-forwarder](https://github.com/awdr74100/telegram-forwarder) ⭐ 3 | 🐛 5 | 🌐 Rust | 📅 2026-09-22 – Many-to-many CLI forwarder that mirrors messages and media between chats, with per-route content filters, recovery of posts deleted at the source, and automatic FloodWait handling.
