...
* [OpenClaw](https://github.com/openclaw/openclaw) ⭐ 386,764 | 🐛 5,779 | 🌐 TypeScript | 📅 2026-08-19 – Self-hosted AI assistant that connects Claude to Telegram (and 7 other channels) from a single deployment. Supports hooks, plugins, and tools. Telegram setup: <https://clawdbot.blog/channels/telegram/>

* [TikTok Live Recorder | TikRec](https://t.me/tikrec_live_bot) – [Open Source](https://github.com/Michele0303/tiktok-live-recorder) ⭐ 881 | 🐛 138 | 🌐 Python | 📅 2026-08-12 bot that records TikTok live streams and delivers the MP4 to your Telegram chat. Free, with a public archive at [tikrec.com](https://tikrec.com).
...
* [python-telegram-bot](https://github.com/python-telegram-bot/python-telegram-bot) ⭐ 29,418 | 🐛 33 | 🌐 Python | 📅 2026-08-16 – We have made you a wrapper you can't refuse
* [telethon](https://github.com/LonamiWebs/Telethon) ⚠️ Archived – Pure Python 3 MTProto API Telegram client library, for bots too!
* [pyTelegramBotAPI](https://github.com/eternnoir/pyTelegramBotAPI) ⭐ 8,761 | 🐛 3 | 🌐 Python | 📅 2026-08-18 – A simple, but extensible Python implementation
* [AIOGram](https://github.com/aiogram/aiogram) ⭐ 5,837 | 🐛 54 | 🌐 Python | 📅 2026-08-18 – A pretty simple and fully asynchronous framework for Telegram Bot API.
...
* [node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) ⭐ 9,200 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-18 – Telegram Bot API for Node.js
* [Telegraf](https://github.com/telegraf/telegraf) ⭐ 9,177 | 🐛 79 | 🌐 TypeScript | 📅 2025-01-11 – Telegram bot framework (JavaScript, Typescript, Node.js)
* [grammY](https://github.com/grammyjs/grammY) ⭐ 3,720 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-17 – The Telegram Bot Framework. (JavaScript, Typescript, Node.js)
...
* [WTelegramClient](https://github.com/wiz0u/WTelegramClient/) ⭐ 1,313 | 🐛 0 | 🌐 C# | 📅 2026-08-18 – Telegram Client API (MTProto) library written 100% in C# and .NET Standard
...
* [telegram-bot-sdk](https://github.com/irazasyed/telegram-bot-sdk) ⭐ 3,303 | 🐛 29 | 🌐 PHP | 📅 2026-08-18 – Telegram Bot API PHP SDK. Lets you build Telegram Bots easily! Supports Laravel out of the box
...
* [gotd](https://github.com/gotd/td) ⭐ 2,312 | 🐛 10 | 🌐 Go | 📅 2026-08-17 – Telegram client, in pure Go. (MTProto API)
...
* [Frankenstein](https://github.com/ayrat555/frankenstein) ⭐ 367 | 🐛 12 | 🌐 Rust | 📅 2026-07-19 – Telegram bot API client for Rust.
...
* [Telegram-Archive](https://github.com/GeiserX/Telegram-Archive) ⭐ 183 | 🐛 3 | 🌐 Python | 📅 2026-08-19 – Docker-based tool for archiving Telegram channels and groups with full media support, incremental backups, and a local web viewer.
* [shell2telegram](https://github.com/msoap/shell2telegram) ⭐ 168 | 🐛 0 | 🌐 Go | 📅 2025-08-22 – Telegram bot constructor from command-line.
* [OpenPaw](https://github.com/daxaur/openpaw) ⭐ 160 | 🐛 0 | 🌐 TypeScript | 📅 2026-05-23 – Open-source CLI tool (`npx pawmode`) with a built-in Telegram bridge to chat with Claude from your phone. Includes 38 skills covering email, calendar, Spotify, smart home, GitHub, Slack and more.
...
* [Teleton](https://github.com/TONresistor/teleton-agent) ⭐ 90 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-19 – Autonomous AI agent for Telegram with TON blockchain integration, 15 LLM providers, plugin SDK, and hybrid RAG memory. Self-hosted.
...
* [Awesome DevOps Telegram](https://github.com/palark/awesome-devops-telegram) ⭐ 288 | 🐛 0 | 📅 2026-07-14 – A curated list of Telegram channels and groups dedicated to DevOps, SRE, and Platform Engineering in English.
