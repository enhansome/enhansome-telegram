...
* [OpenClaw](https://github.com/openclaw/openclaw) ⭐ 389,630 | 🐛 7,190 | 🌐 TypeScript | 📅 2026-09-14 – Self-hosted AI assistant that connects Claude to Telegram (and 7 other channels) from a single deployment. Supports hooks, plugins, and tools. Telegram setup: <https://clawdbot.blog/channels/telegram/>
...
* [Aeon](https://github.com/aeonfun/aeon) ⭐ 728 | 🐛 1 | 🌐 Shell | 📅 2026-09-12 – [Open Source](https://github.com/aeonfun/aeon) ⭐ 728 | 🐛 1 | 🌐 Shell | 📅 2026-09-12 autonomous AI agent framework, self-hosted under MIT, that reports to Telegram with interactive inline buttons and inbound command routing via webhook and long-polling.
...
* [python-telegram-bot](https://github.com/python-telegram-bot/python-telegram-bot) ⭐ 29,462 | 🐛 32 | 🌐 Python | 📅 2026-09-13 – We have made you a wrapper you can't refuse
* [telethon](https://github.com/LonamiWebs/Telethon) ⚠️ Archived – Pure Python 3 MTProto API Telegram client library, for bots too!
* [pyTelegramBotAPI](https://github.com/eternnoir/pyTelegramBotAPI) ⭐ 8,777 | 🐛 5 | 🌐 Python | 📅 2026-09-12 – A simple, but extensible Python implementation
...
* [ErisPulse](https://github.com/ErisPulse/ErisPulse) ⭐ 57 | 🐛 0 | 🌐 Python | 📅 2026-09-13 – Async-first Python bot framework with Telegram support, unified adapter interface, and plugin system; also supports multiple other platforms.
...
* [GoyGram](https://github.com/GoyGram/GoyGram) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2026-09-13 – Unified Bot API + MTProto framework with a Rust crypto/codec core.
...
* [mtcute](https://github.com/mtcute/mtcute) ⭐ 556 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-30 – modern typescript library for mtproto
...
* [gotd](https://github.com/gotd/td) ⭐ 2,339 | 🐛 16 | 🌐 Go | 📅 2026-08-25 – Telegram client, in pure Go. (MTProto API)
...
* [TelegramCode](https://github.com/olosegres/telegramcode) ⭐ 6 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-13 – Self-hosted bot to run OpenCode and Claude Code coding agents on your machine or VPS and drive them from Telegram by voice or text, one topic per project.
...
* [Telegram-Archive](https://github.com/GeiserX/Telegram-Archive) ⭐ 205 | 🐛 4 | 🌐 Python | 📅 2026-09-13 – Docker-based tool for archiving Telegram channels and groups with full media support, incremental backups, and a local web viewer.
...
* [Untether](https://github.com/littlebearapps/untether) ⭐ 66 | 🐛 172 | 🌐 Python | 📅 2026-09-13 – Self-hosted bot bridging AI coding agents to Telegram with inline keyboards, voice transcription, real-time streaming, and file transfer.
...
* [telegram-forwarder](https://github.com/awdr74100/telegram-forwarder) ⭐ 3 | 🐛 5 | 🌐 Rust | 📅 2026-09-13 – Many-to-many CLI forwarder that mirrors messages and media between chats, with per-route content filters, recovery of posts deleted at the source, and automatic FloodWait handling.
