...
* [OpenClaw](https://github.com/openclaw/openclaw) ⭐ 389,328 | 🐛 6,569 | 🌐 TypeScript | 📅 2026-09-10 – Self-hosted AI assistant that connects Claude to Telegram (and 7 other channels) from a single deployment. Supports hooks, plugins, and tools. Telegram setup: <https://clawdbot.blog/channels/telegram/>
...
* [Aeon](https://github.com/aeonfun/aeon) ⭐ 721 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-10 – [Open Source](https://github.com/aeonfun/aeon) ⭐ 721 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-10 autonomous AI agent framework, self-hosted under MIT, that reports to Telegram with interactive inline buttons and inbound command routing via webhook and long-polling.
...
* [@demo\_aiogramshopbot](https://t.me/demo_aiogramshopbot) – [Open Source](https://github.com/ilyarolf/AiogramShopBot) ⭐ 236 | 🐛 1 | 🌐 Python | 📅 2026-08-31 Telegram shop bot built with Aiogram 3, supporting digital and physical product sales, cryptocurrency payments (BTC, ETH, LTC, SOL, BNB, USDT), referral system and web admin panel.
...
* [python-telegram-bot](https://github.com/python-telegram-bot/python-telegram-bot) ⭐ 29,461 | 🐛 40 | 🌐 Python | 📅 2026-09-06 – We have made you a wrapper you can't refuse
...
* [AIOGram](https://github.com/aiogram/aiogram) ⭐ 5,863 | 🐛 78 | 🌐 Python | 📅 2026-08-26 – A pretty simple and fully asynchronous framework for Telegram Bot API.
...
* [ErisPulse](https://github.com/ErisPulse/ErisPulse) ⭐ 56 | 🐛 0 | 🌐 Python | 📅 2026-09-09 – Async-first Python bot framework with Telegram support, unified adapter interface, and plugin system; also supports multiple other platforms.
* [Teledigest](https://github.com/igoropaniuk/teledigest) ⭐ 24 | 🐛 1 | 🌐 Python | 📅 2026-03-07 – A LLM-driven framework for building Telegram digest and channel-analysis bots.
...
* [GoyGram](https://github.com/GoyGram/GoyGram) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2026-09-10 – Unified Bot API + MTProto framework with a Rust crypto/codec core.
...
* [node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) ⭐ 9,205 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-07 – Telegram Bot API for Node.js
...
* [grammY](https://github.com/grammyjs/grammY) ⭐ 3,739 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-26 – The Telegram Bot Framework. (JavaScript, Typescript, Node.js)
...
* [GramIO](https://github.com/gramiojs/gramio) ⭐ 292 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-09 – Powerful, extensible and really type-safe Telegram Bot API framework
...
* [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) ⭐ 6,402 | 🐛 174 | 🌐 Go | 📅 2024-08-14 – Golang bindings for the Telegram Bot API.
* [telebot](https://github.com/tucnak/telebot) ⭐ 4,632 | 🐛 66 | 🌐 Go | 📅 2026-06-16 – Telegram bot framework written in Go
* [gotd](https://github.com/gotd/td) ⭐ 2,335 | 🐛 13 | 🌐 Go | 📅 2026-08-25 – Telegram client, in pure Go. (MTProto API)
...
* [Telegram-Archive](https://github.com/GeiserX/Telegram-Archive) ⭐ 200 | 🐛 2 | 🌐 Python | 📅 2026-09-08 – Docker-based tool for archiving Telegram channels and groups with full media support, incremental backups, and a local web viewer.
...
* [VideoDownloaderBot](https://github.com/Avazbek22/VideoDownloaderBot) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2026-09-07 – Self-hosted Telegram bot for receiving supported media as video, original files, or MP3.
...
* [LinkDownloaderBotForGroups](https://github.com/Avazbek22/LinkDownloaderBotForGroups) ⭐ 3 | 🐛 1 | 🌐 Python | 📅 2026-09-03 – Self-hosted bot that turns supported video links into native Telegram posts for content that users are authorized to download and share.
...
* [telegram-forwarder](https://github.com/awdr74100/telegram-forwarder) ⭐ 2 | 🐛 5 | 🌐 Rust | 📅 2026-09-09 – Many-to-many CLI forwarder that mirrors messages and media between chats, with per-route content filters, recovery of posts deleted at the source, and automatic FloodWait handling.
...
* [Awesome-grammY](https://github.com/grammyjs/awesome-grammY) ⭐ 279 | 🐛 6 | 📅 2026-07-27 – This is a curated list of projects that are using grammY.
