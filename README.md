...
* [OpenClaw](https://github.com/openclaw/openclaw) ⭐ 389,716 | 🐛 7,282 | 🌐 TypeScript | 📅 2026-09-15 – Self-hosted AI assistant that connects Claude to Telegram (and 7 other channels) from a single deployment. Supports hooks, plugins, and tools. Telegram setup: <https://clawdbot.blog/channels/telegram/>
...
* [Aeon](https://github.com/aeonfun/aeon) ⭐ 729 | 🐛 1 | 🌐 Shell | 📅 2026-09-15 – [Open Source](https://github.com/aeonfun/aeon) ⭐ 729 | 🐛 1 | 🌐 Shell | 📅 2026-09-15 autonomous AI agent framework, self-hosted under MIT, that reports to Telegram with interactive inline buttons and inbound command routing via webhook and long-polling.
...
* [python-telegram-bot](https://github.com/python-telegram-bot/python-telegram-bot) ⭐ 29,465 | 🐛 31 | 🌐 Python | 📅 2026-09-15 – We have made you a wrapper you can't refuse
* [telethon](https://github.com/LonamiWebs/Telethon) ⚠️ Archived – Pure Python 3 MTProto API Telegram client library, for bots too!
* [pyTelegramBotAPI](https://github.com/eternnoir/pyTelegramBotAPI) ⭐ 8,778 | 🐛 5 | 🌐 Python | 📅 2026-09-12 – A simple, but extensible Python implementation
* [AIOGram](https://github.com/aiogram/aiogram) ⭐ 5,864 | 🐛 78 | 🌐 Python | 📅 2026-08-26 – A pretty simple and fully asynchronous framework for Telegram Bot API.
...
* [ErisPulse](https://github.com/ErisPulse/ErisPulse) ⭐ 57 | 🐛 0 | 🌐 Python | 📅 2026-09-14 – Async-first Python bot framework with Telegram support, unified adapter interface, and plugin system; also supports multiple other platforms.
...
* [GoyGram](https://github.com/GoyGram/GoyGram) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2026-09-14 – Unified Bot API + MTProto framework with a Rust crypto/codec core.
...
* [node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) ⭐ 9,203 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-07 – Telegram Bot API for Node.js
* [Telegraf](https://github.com/telegraf/telegraf) ⭐ 9,188 | 🐛 80 | 🌐 TypeScript | 📅 2025-01-11 – Telegram bot framework (JavaScript, Typescript, Node.js)
* [grammY](https://github.com/grammyjs/grammY) ⭐ 3,743 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-26 – The Telegram Bot Framework. (JavaScript, Typescript, Node.js)
...
* [mtcute](https://github.com/mtcute/mtcute) ⭐ 558 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-30 – modern typescript library for mtproto
...
* [GramIO](https://github.com/gramiojs/gramio) ⭐ 295 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-09 – Powerful, extensible and really type-safe Telegram Bot API framework
* [MTKruto](https://github.com/MTKruto/MTKruto) ⭐ 174 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-25 – Cross-runtime JavaScript library for building Telegram clients.
...
* [WTelegramClient](https://github.com/wiz0u/WTelegramClient/) ⭐ 1,319 | 🐛 0 | 🌐 C# | 📅 2026-08-18 – Telegram Client API (MTProto) library written 100% in C# and .NET Standard
...
* [php-telegram-bot](https://github.com/php-telegram-bot/core) ⭐ 4,015 | 🐛 84 | 🌐 PHP | 📅 2025-03-20 – PHP Telegram Bot based on the official Telegram Bot API
* [MadeLineProto](https://github.com/danog/MadelineProto) ⭐ 3,514 | 🐛 75 | 🌐 PHP | 📅 2026-09-06 – Async PHP client/server API for the telegram MTProto protocol.
...
* [Nutgram](https://github.com/SergiX44/Nutgram) ⭐ 746 | 🐛 5 | 🌐 PHP | 📅 2026-08-28 – Fast, powerful and Laravel friendly PHP library to build from simple to the most complex Telegram bots
...
* [gotd](https://github.com/gotd/td) ⭐ 2,344 | 🐛 16 | 🌐 Go | 📅 2026-08-25 – Telegram client, in pure Go. (MTProto API)
...
* [TelegramCode](https://github.com/olosegres/telegramcode) ⭐ 6 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-14 – Self-hosted bot to run OpenCode and Claude Code coding agents on your machine or VPS and drive them from Telegram by voice or text, one topic per project.
...
* [tgbot-cpp](https://github.com/reo7sp/tgbot-cpp) ⭐ 1,189 | 🐛 0 | 🌐 C++ | 📅 2026-09-14 – C++ library for Telegram bot API.
* [telegram-bot-api](https://github.com/StefanoBelli/xxtelebot) ⭐ 44 | 🐛 0 | 🌐 C++ | 📅 2020-03-30 – C++ Telegram Bot API.

#### Rust

* [teloxide](https://github.com/teloxide/teloxide) ⭐ 4,240 | 🐛 73 | 🌐 Rust | 📅 2026-08-08 – Rust framework for Telegram Bot API bots.
...
* [Maltego Telegram](https://github.com/vognik/maltego-telegram) ⭐ 564 | 🐛 3 | 🌐 Python | 📅 2026-01-27 – Rich Set of Entities & Transforms for OSINT on Telegram with Maltego
* [telegram-id](https://github.com/GabrielRF/telegram-id) ⭐ 208 | 🐛 0 | 📅 2022-02-24 – Guide on how to get Telegram IDs
* [Telegram-Archive](https://github.com/GeiserX/Telegram-Archive) ⭐ 205 | 🐛 2 | 🌐 Python | 📅 2026-09-14 – Docker-based tool for archiving Telegram channels and groups with full media support, incremental backups, and a local web viewer.
...
* [Teleton](https://github.com/TONresistor/teleton-agent) ⭐ 91 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-06 – Autonomous AI agent for Telegram with TON blockchain integration, 15 LLM providers, plugin SDK, and hybrid RAG memory. Self-hosted.
* [Untether](https://github.com/littlebearapps/untether) ⭐ 66 | 🐛 172 | 🌐 Python | 📅 2026-09-14 – Self-hosted bot bridging AI coding agents to Telegram with inline keyboards, voice transcription, real-time streaming, and file transfer.
...
* [telegram-forwarder](https://github.com/awdr74100/telegram-forwarder) ⭐ 3 | 🐛 5 | 🌐 Rust | 📅 2026-09-14 – Many-to-many CLI forwarder that mirrors messages and media between chats, with per-route content filters, recovery of posts deleted at the source, and automatic FloodWait handling.
...
* [Awesome-grammY](https://github.com/grammyjs/awesome-grammY) ⭐ 280 | 🐛 6 | 📅 2026-07-27 – This is a curated list of projects that are using grammY.
