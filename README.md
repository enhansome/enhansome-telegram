...
* [OpenClaw](https://github.com/openclaw/openclaw) ⭐ 390,031 | 🐛 7,675 | 🌐 TypeScript | 📅 2026-09-18 – Self-hosted AI assistant that connects Claude to Telegram (and 7 other channels) from a single deployment. Supports hooks, plugins, and tools. Telegram setup: <https://clawdbot.blog/channels/telegram/>
* [TikTok Live Recorder | TikRec](https://t.me/tikrec_live_bot) – [Open Source](https://github.com/Michele0303/tiktok-live-recorder) ⭐ 905 | 🐛 138 | 🌐 Python | 📅 2026-08-12 bot that records TikTok live streams and delivers the MP4 to your Telegram chat. Free, with a public archive at [tikrec.com](https://tikrec.com).
* [Aeon](https://github.com/aeonfun/aeon) ⭐ 739 | 🐛 1 | 🌐 Shell | 📅 2026-09-17 – [Open Source](https://github.com/aeonfun/aeon) ⭐ 739 | 🐛 1 | 🌐 Shell | 📅 2026-09-17 autonomous AI agent framework, self-hosted under MIT, that reports to Telegram with interactive inline buttons and inbound command routing via webhook and long-polling.
...
* [python-telegram-bot](https://github.com/python-telegram-bot/python-telegram-bot) ⭐ 29,469 | 🐛 30 | 🌐 Python | 📅 2026-09-17 – We have made you a wrapper you can't refuse
* [telethon](https://github.com/LonamiWebs/Telethon) ⚠️ Archived – Pure Python 3 MTProto API Telegram client library, for bots too!
* [pyTelegramBotAPI](https://github.com/eternnoir/pyTelegramBotAPI) ⭐ 8,780 | 🐛 5 | 🌐 Python | 📅 2026-09-17 – A simple, but extensible Python implementation
* [AIOGram](https://github.com/aiogram/aiogram) ⭐ 5,864 | 🐛 79 | 🌐 Python | 📅 2026-08-26 – A pretty simple and fully asynchronous framework for Telegram Bot API.
...
* [Telegraf](https://github.com/telegraf/telegraf) ⭐ 9,190 | 🐛 80 | 🌐 TypeScript | 📅 2025-01-11 – Telegram bot framework (JavaScript, Typescript, Node.js)
* [grammY](https://github.com/grammyjs/grammY) ⭐ 3,746 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-26 – The Telegram Bot Framework. (JavaScript, Typescript, Node.js)
...
* [GramIO](https://github.com/gramiojs/gramio) ⭐ 295 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-09 – Powerful, extensible and really type-safe Telegram Bot API framework
...
* [tg-rich-messages](https://github.com/vdistortion/tg-rich-messages) ⭐ 8 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-17 – Platform-independent TypeScript builder for Telegram Rich Messages (HTML mode). Zero dependencies, fully typed, tree-shakeable.
* [telegram-links](https://github.com/siteboss777-lgtm/telegram-links) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-17 – Builds and validates every t.me and tg:// link format Telegram documents — bot deep links, Mini App, share, phone, public and private posts — with zero dependencies and no network calls.
...
* [MadeLineProto](https://github.com/danog/MadelineProto) ⭐ 3,517 | 🐛 75 | 🌐 PHP | 📅 2026-09-17 – Async PHP client/server API for the telegram MTProto protocol.
...
* [gotd](https://github.com/gotd/td) ⭐ 2,347 | 🐛 17 | 🌐 Go | 📅 2026-08-25 – Telegram client, in pure Go. (MTProto API)
...
* [teloxide](https://github.com/teloxide/teloxide) ⭐ 4,241 | 🐛 74 | 🌐 Rust | 📅 2026-09-15 – Rust framework for Telegram Bot API bots.
...
* [Telegram-Archive](https://github.com/GeiserX/Telegram-Archive) ⭐ 205 | 🐛 3 | 🌐 Python | 📅 2026-09-18 – Docker-based tool for archiving Telegram channels and groups with full media support, incremental backups, and a local web viewer.
...
* [Untether](https://github.com/littlebearapps/untether) ⭐ 68 | 🐛 172 | 🌐 Python | 📅 2026-09-14 – Self-hosted bot bridging AI coding agents to Telegram with inline keyboards, voice transcription, real-time streaming, and file transfer.
