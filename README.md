...
* [OpenClaw](https://github.com/openclaw/openclaw) ⭐ 389,263 | 🐛 6,428 | 🌐 TypeScript | 📅 2026-09-09 – Self-hosted AI assistant that connects Claude to Telegram (and 7 other channels) from a single deployment. Supports hooks, plugins, and tools. Telegram setup: <https://clawdbot.blog/channels/telegram/>
...
* [Aeon](https://github.com/aeonfun/aeon) ⭐ 720 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-08 – [Open Source](https://github.com/aeonfun/aeon) ⭐ 720 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-08 autonomous AI agent framework, self-hosted under MIT, that reports to Telegram with interactive inline buttons and inbound command routing via webhook and long-polling.
...
* [python-telegram-bot](https://github.com/python-telegram-bot/python-telegram-bot) ⭐ 29,458 | 🐛 39 | 🌐 Python | 📅 2026-09-06 – We have made you a wrapper you can't refuse
...
* [AIOGram](https://github.com/aiogram/aiogram) ⭐ 5,862 | 🐛 78 | 🌐 Python | 📅 2026-08-26 – A pretty simple and fully asynchronous framework for Telegram Bot API.
...
* [ErisPulse](https://github.com/ErisPulse/ErisPulse) ⭐ 56 | 🐛 0 | 🌐 Python | 📅 2026-09-08 – Async-first Python bot framework with Telegram support, unified adapter interface, and plugin system; also supports multiple other platforms.
...
* [GoyGram](https://github.com/GoyGram/GoyGram) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2026-09-09 – Unified Bot API + MTProto framework with a Rust crypto/codec core.
...
* [grammY](https://github.com/grammyjs/grammY) ⭐ 3,738 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-26 – The Telegram Bot Framework. (JavaScript, Typescript, Node.js)
...
* [GramIO](https://github.com/gramiojs/gramio) ⭐ 292 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-25 – Powerful, extensible and really type-safe Telegram Bot API framework
...
* [MadeLineProto](https://github.com/danog/MadelineProto) ⭐ 3,512 | 🐛 75 | 🌐 PHP | 📅 2026-09-06 – Async PHP client/server API for the telegram MTProto protocol.
...
* [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) ⭐ 6,403 | 🐛 174 | 🌐 Go | 📅 2024-08-14 – Golang bindings for the Telegram Bot API.
* [telebot](https://github.com/tucnak/telebot) ⭐ 4,631 | 🐛 66 | 🌐 Go | 📅 2026-06-16 – Telegram bot framework written in Go
* [gotd](https://github.com/gotd/td) ⭐ 2,334 | 🐛 13 | 🌐 Go | 📅 2026-08-25 – Telegram client, in pure Go. (MTProto API)
* [MTProto](https://github.com/xelaj/mtproto) ⭐ 1,349 | 🐛 33 | 🌐 Go | 📅 2024-03-13 – Full native implementation of Telegram Client API on pure Go.
* [gotelebot](https://github.com/eternnoir/gotelebot) ⭐ 21 | 🐛 3 | 🌐 Go | 📅 2021-04-12 – Implementation for the Telegram Bot API.

#### Java

* [TelegramBots](https://github.com/rubenlagus/TelegramBots) ⭐ 5,513 | 🐛 196 | 🌐 Java | 📅 2026-09-07 – Java library to create bots using Telegram Bots API.
...
* [TelegramCode](https://github.com/olosegres/telegramcode) ⭐ 6 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-08 – Self-hosted bot to run OpenCode and Claude Code coding agents on your machine or VPS and drive them from Telegram by voice or text, one topic per project.
...
* [teloxide](https://github.com/teloxide/teloxide) ⭐ 4,235 | 🐛 73 | 🌐 Rust | 📅 2026-08-08 – Rust framework for Telegram Bot API bots.
...
* [Frankenstein](https://github.com/ayrat555/frankenstein) ⭐ 371 | 🐛 15 | 🌐 Rust | 📅 2026-08-28 – Telegram bot API client for Rust.
...
* [tgbotapi](https://github.com/InsanusMokrassar/TelegramBotAPI) ⭐ 443 | 🐛 19 | 🌐 Kotlin | 📅 2026-09-08 – Type-safe library for work with Telegram Bot API.
...
* [Telegram-Archive](https://github.com/GeiserX/Telegram-Archive) ⭐ 200 | 🐛 1 | 🌐 Python | 📅 2026-09-08 – Docker-based tool for archiving Telegram channels and groups with full media support, incremental backups, and a local web viewer.
...
* [telegram-owl](https://github.com/beeyev/telegram-owl) ⭐ 55 | 🐛 0 | 🌐 Go | 📅 2026-07-26 – Send messages and files to Telegram chats and channels, directly from terminal. Lightweight tool written in Go.
...
* [telegram-forwarder](https://github.com/awdr74100/telegram-forwarder) ⭐ 2 | 🐛 5 | 🌐 Rust | 📅 2026-09-08 – Many-to-many CLI forwarder that mirrors messages and media between chats, with per-route content filters, recovery of posts deleted at the source, and automatic FloodWait handling.
