...
* [OpenClaw](https://github.com/openclaw/openclaw) ⭐ 388,978 | 🐛 6,290 | 🌐 TypeScript | 📅 2026-09-06 – Self-hosted AI assistant that connects Claude to Telegram (and 7 other channels) from a single deployment. Supports hooks, plugins, and tools. Telegram setup: <https://clawdbot.blog/channels/telegram/>
* [TikTok Live Recorder | TikRec](https://t.me/tikrec_live_bot) – [Open Source](https://github.com/Michele0303/tiktok-live-recorder) ⭐ 898 | 🐛 137 | 🌐 Python | 📅 2026-08-12 bot that records TikTok live streams and delivers the MP4 to your Telegram chat. Free, with a public archive at [tikrec.com](https://tikrec.com).
* [Aeon](https://github.com/aeonfun/aeon) ⭐ 716 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-05 – [Open Source](https://github.com/aeonfun/aeon) ⭐ 716 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-05 autonomous AI agent framework, self-hosted under MIT, that reports to Telegram with interactive inline buttons and inbound command routing via webhook and long-polling.
...
* [python-telegram-bot](https://github.com/python-telegram-bot/python-telegram-bot) ⭐ 29,444 | 🐛 39 | 🌐 Python | 📅 2026-09-06 – We have made you a wrapper you can't refuse
* [telethon](https://github.com/LonamiWebs/Telethon) ⚠️ Archived – Pure Python 3 MTProto API Telegram client library, for bots too!
* [pyTelegramBotAPI](https://github.com/eternnoir/pyTelegramBotAPI) ⭐ 8,773 | 🐛 5 | 🌐 Python | 📅 2026-08-28 – A simple, but extensible Python implementation
* [AIOGram](https://github.com/aiogram/aiogram) ⭐ 5,858 | 🐛 70 | 🌐 Python | 📅 2026-08-26 – A pretty simple and fully asynchronous framework for Telegram Bot API.
...
* [node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) ⭐ 9,203 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-05 – Telegram Bot API for Node.js
...
* [telebot](https://github.com/tucnak/telebot) ⭐ 4,630 | 🐛 66 | 🌐 Go | 📅 2026-06-16 – Telegram bot framework written in Go
...
* [TelegramBots](https://github.com/rubenlagus/TelegramBots) ⭐ 5,512 | 🐛 197 | 🌐 Java | 📅 2026-09-06 – Java library to create bots using Telegram Bots API.
...
* [teloxide](https://github.com/teloxide/teloxide) ⭐ 4,230 | 🐛 73 | 🌐 Rust | 📅 2026-08-08 – Rust framework for Telegram Bot API bots.
...
* [Telegram-Archive](https://github.com/GeiserX/Telegram-Archive) ⭐ 198 | 🐛 1 | 🌐 Python | 📅 2026-09-04 – Docker-based tool for archiving Telegram channels and groups with full media support, incremental backups, and a local web viewer.
...
* [Teleton](https://github.com/TONresistor/teleton-agent) ⭐ 90 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-05 – Autonomous AI agent for Telegram with TON blockchain integration, 15 LLM providers, plugin SDK, and hybrid RAG memory. Self-hosted.
