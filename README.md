...
* [OpenClaw](https://github.com/openclaw/openclaw) ⭐ 388,892 | 🐛 6,224 | 🌐 TypeScript | 📅 2026-09-05 – Self-hosted AI assistant that connects Claude to Telegram (and 7 other channels) from a single deployment. Supports hooks, plugins, and tools. Telegram setup: <https://clawdbot.blog/channels/telegram/>
* [TikTok Live Recorder | TikRec](https://t.me/tikrec_live_bot) – [Open Source](https://github.com/Michele0303/tiktok-live-recorder) ⭐ 897 | 🐛 137 | 🌐 Python | 📅 2026-08-12 bot that records TikTok live streams and delivers the MP4 to your Telegram chat. Free, with a public archive at [tikrec.com](https://tikrec.com).
* [Aeon](https://github.com/aeonfun/aeon) ⭐ 715 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-04 – [Open Source](https://github.com/aeonfun/aeon) ⭐ 715 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-04 autonomous AI agent framework, self-hosted under MIT, that reports to Telegram with interactive inline buttons and inbound command routing via webhook and long-polling.
...
* [@demo\_aiogramshopbot](https://t.me/demo_aiogramshopbot) – [Open Source](https://github.com/ilyarolf/AiogramShopBot) ⭐ 233 | 🐛 1 | 🌐 Python | 📅 2026-08-31 Telegram shop bot built with Aiogram 3, supporting digital and physical product sales, cryptocurrency payments (BTC, ETH, LTC, SOL, BNB, USDT), referral system and web admin panel.
...
* [python-telegram-bot](https://github.com/python-telegram-bot/python-telegram-bot) ⭐ 29,446 | 🐛 38 | 🌐 Python | 📅 2026-09-01 – We have made you a wrapper you can't refuse
* [telethon](https://github.com/LonamiWebs/Telethon) ⚠️ Archived – Pure Python 3 MTProto API Telegram client library, for bots too!
* [pyTelegramBotAPI](https://github.com/eternnoir/pyTelegramBotAPI) ⭐ 8,773 | 🐛 6 | 🌐 Python | 📅 2026-08-28 – A simple, but extensible Python implementation
* [AIOGram](https://github.com/aiogram/aiogram) ⭐ 5,857 | 🐛 70 | 🌐 Python | 📅 2026-08-26 – A pretty simple and fully asynchronous framework for Telegram Bot API.
...
* [ErisPulse](https://github.com/ErisPulse/ErisPulse) ⭐ 56 | 🐛 0 | 🌐 Python | 📅 2026-09-04 – Async-first Python bot framework with Telegram support, unified adapter interface, and plugin system; also supports multiple other platforms.
...
* [GoyGram](https://github.com/GoyGram/GoyGram) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2026-09-02 – Unified Bot API + MTProto framework with a Rust crypto/codec core.
...
* [telegram-table-renderer](https://github.com/shali10/awesome-agent-skills/tree/main/packages/telegram-table-renderer) ⭐ 0 | 🐛 1 | 🌐 Python | 📅 2026-09-01 – Zero-dependency Python Markdown table formatter with CJK visual width compensation and mobile-friendly graceful degradation.
...
* [node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) ⭐ 9,205 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-04 – Telegram Bot API for Node.js
* [Telegraf](https://github.com/telegraf/telegraf) ⭐ 9,177 | 🐛 80 | 🌐 TypeScript | 📅 2025-01-11 – Telegram bot framework (JavaScript, Typescript, Node.js)
...
* [mtcute](https://github.com/mtcute/mtcute) ⭐ 554 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-30 – modern typescript library for mtproto
...
* [MadeLineProto](https://github.com/danog/MadelineProto) ⭐ 3,507 | 🐛 75 | 🌐 PHP | 📅 2026-08-30 – Async PHP client/server API for the telegram MTProto protocol.
* [telegram-bot-sdk](https://github.com/irazasyed/telegram-bot-sdk) ⭐ 3,301 | 🐛 28 | 🌐 PHP | 📅 2026-08-20 – Telegram Bot API PHP SDK. Lets you build Telegram Bots easily! Supports Laravel out of the box
* [TelegramBot/Api](https://github.com/TelegramBot/Api) ⭐ 1,195 | 🐛 63 | 🌐 PHP | 📅 2025-07-10 – Native PHP Wrapper for Telegram BOT API
* [Nutgram](https://github.com/SergiX44/Nutgram) ⭐ 744 | 🐛 4 | 🌐 PHP | 📅 2026-08-28 – Fast, powerful and Laravel friendly PHP library to build from simple to the most complex Telegram bots
...
* [gotd](https://github.com/gotd/td) ⭐ 2,329 | 🐛 13 | 🌐 Go | 📅 2026-08-25 – Telegram client, in pure Go. (MTProto API)
* [MTProto](https://github.com/xelaj/mtproto) ⭐ 1,347 | 🐛 33 | 🌐 Go | 📅 2024-03-13 – Full native implementation of Telegram Client API on pure Go.
* [gotelebot](https://github.com/eternnoir/gotelebot) ⭐ 21 | 🐛 3 | 🌐 Go | 📅 2021-04-12 – Implementation for the Telegram Bot API.

#### Java

* [TelegramBots](https://github.com/rubenlagus/TelegramBots) ⭐ 5,511 | 🐛 196 | 🌐 Java | 📅 2026-08-31 – Java library to create bots using Telegram Bots API.
...
* [tgbot-cpp](https://github.com/reo7sp/tgbot-cpp) ⭐ 1,188 | 🐛 67 | 🌐 C++ | 📅 2026-08-21 – C++ library for Telegram bot API.
* [telegram-bot-api](https://github.com/StefanoBelli/xxtelebot) ⭐ 44 | 🐛 0 | 🌐 C++ | 📅 2020-03-30 – C++ Telegram Bot API.

#### Rust

* [teloxide](https://github.com/teloxide/teloxide) ⭐ 4,227 | 🐛 73 | 🌐 Rust | 📅 2026-08-08 – Rust framework for Telegram Bot API bots.
...
* [tgbotapi](https://github.com/InsanusMokrassar/TelegramBotAPI) ⭐ 443 | 🐛 19 | 🌐 Kotlin | 📅 2026-09-01 – Type-safe library for work with Telegram Bot API.
...
* [telegram-send](https://github.com/rahiel/telegram-send) ⭐ 1,013 | 🐛 22 | 🌐 Python | 📅 2026-05-19 – Send messages and files over Telegram from the command-line.
* [Maltego Telegram](https://github.com/vognik/maltego-telegram) ⭐ 562 | 🐛 3 | 🌐 Python | 📅 2026-01-27 – Rich Set of Entities & Transforms for OSINT on Telegram with Maltego
* [telegram-id](https://github.com/GabrielRF/telegram-id) ⭐ 208 | 🐛 0 | 📅 2022-02-24 – Guide on how to get Telegram IDs
* [Telegram-Archive](https://github.com/GeiserX/Telegram-Archive) ⭐ 197 | 🐛 0 | 🌐 Python | 📅 2026-09-04 – Docker-based tool for archiving Telegram channels and groups with full media support, incremental backups, and a local web viewer.
...
* [Teleton](https://github.com/TONresistor/teleton-agent) ⭐ 90 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-28 – Autonomous AI agent for Telegram with TON blockchain integration, 15 LLM providers, plugin SDK, and hybrid RAG memory. Self-hosted.
* [Untether](https://github.com/littlebearapps/untether) ⭐ 66 | 🐛 173 | 🌐 Python | 📅 2026-08-31 – Self-hosted bot bridging AI coding agents to Telegram with inline keyboards, voice transcription, real-time streaming, and file transfer.
...
* [VideoDownloaderBot](https://github.com/Avazbek22/VideoDownloaderBot) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-08-23 – Self-hosted Telegram bot for receiving supported media as video, original files, or MP3.
...
* [telegram-forwarder](https://github.com/awdr74100/telegram-forwarder) ⭐ 1 | 🐛 5 | 🌐 Rust | 📅 2026-09-05 – Many-to-many CLI forwarder that mirrors messages and media between chats, with per-route content filters, recovery of posts deleted at the source, and automatic FloodWait handling.
* [telethon-plus](https://github.com/psyb0t/docker-telethon-plus) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-08-01 – Self-hosted HTTP + MCP API wrapping a full Telegram user account via Telethon, with async jobs and generated Go/Python clients.
