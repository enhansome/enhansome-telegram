...
* [OpenClaw](https://github.com/openclaw/openclaw) ⭐ 387,613 | 🐛 5,916 | 🌐 TypeScript | 📅 2026-08-26 – Self-hosted AI assistant that connects Claude to Telegram (and 7 other channels) from a single deployment. Supports hooks, plugins, and tools. Telegram setup: <https://clawdbot.blog/channels/telegram/>

* [TikTok Live Recorder | TikRec](https://t.me/tikrec_live_bot) – [Open Source](https://github.com/Michele0303/tiktok-live-recorder) ⭐ 887 | 🐛 138 | 🌐 Python | 📅 2026-08-12 bot that records TikTok live streams and delivers the MP4 to your Telegram chat. Free, with a public archive at [tikrec.com](https://tikrec.com).
...
* [@demo\_aiogramshopbot](https://t.me/demo_aiogramshopbot) – [Open Source](https://github.com/ilyarolf/AiogramShopBot) ⭐ 231 | 🐛 1 | 🌐 Python | 📅 2026-04-23 Telegram shop bot built with Aiogram 3, supporting digital and physical product sales, cryptocurrency payments (BTC, ETH, LTC, SOL, BNB, USDT), referral system and web admin panel.
...
* [python-telegram-bot](https://github.com/python-telegram-bot/python-telegram-bot) ⭐ 29,428 | 🐛 39 | 🌐 Python | 📅 2026-08-23 – We have made you a wrapper you can't refuse
* [telethon](https://github.com/LonamiWebs/Telethon) ⚠️ Archived – Pure Python 3 MTProto API Telegram client library, for bots too!
* [pyTelegramBotAPI](https://github.com/eternnoir/pyTelegramBotAPI) ⭐ 8,766 | 🐛 5 | 🌐 Python | 📅 2026-08-22 – A simple, but extensible Python implementation
* [AIOGram](https://github.com/aiogram/aiogram) ⭐ 5,847 | 🐛 63 | 🌐 Python | 📅 2026-08-26 – A pretty simple and fully asynchronous framework for Telegram Bot API.
...
* [TeleGet](https://github.com/xwc9527/TeleGet) ⭐ 9 | 🐛 1 | 🌐 Python | 📅 2026-02-24 – High-speed Telegram file downloader SDK with multi-connection parallel downloading.
...
* [node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) ⭐ 9,201 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-24 – Telegram Bot API for Node.js
...
* [grammY](https://github.com/grammyjs/grammY) ⭐ 3,720 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-25 – The Telegram Bot Framework. (JavaScript, Typescript, Node.js)
...
* [MTKruto](https://github.com/MTKruto/MTKruto) ⭐ 171 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-25 – Cross-runtime JavaScript library for building Telegram clients.
...
* [MadeLineProto](https://github.com/danog/MadelineProto) ⭐ 3,501 | 🐛 72 | 🌐 PHP | 📅 2026-08-17 – Async PHP client/server API for the telegram MTProto protocol.
...
* [TelegramBot/Api](https://github.com/TelegramBot/Api) ⭐ 1,194 | 🐛 65 | 🌐 PHP | 📅 2025-07-10 – Native PHP Wrapper for Telegram BOT API
* [Nutgram](https://github.com/SergiX44/Nutgram) ⭐ 743 | 🐛 6 | 🌐 PHP | 📅 2026-08-25 – Fast, powerful and Laravel friendly PHP library to build from simple to the most complex Telegram bots
...
* [gotd](https://github.com/gotd/td) ⭐ 2,318 | 🐛 13 | 🌐 Go | 📅 2026-08-25 – Telegram client, in pure Go. (MTProto API)
...
* [TelegramBots](https://github.com/rubenlagus/TelegramBots) ⭐ 5,504 | 🐛 194 | 🌐 Java | 📅 2026-08-22 – Java library to create bots using Telegram Bots API.
...
* [teloxide](https://github.com/teloxide/teloxide) ⭐ 4,215 | 🐛 72 | 🌐 Rust | 📅 2026-08-08 – Rust framework for Telegram Bot API bots.
...
* [Frankenstein](https://github.com/ayrat555/frankenstein) ⭐ 369 | 🐛 12 | 🌐 Rust | 📅 2026-07-19 – Telegram bot API client for Rust.
...
* [Maltego Telegram](https://github.com/vognik/maltego-telegram) ⭐ 555 | 🐛 3 | 🌐 Python | 📅 2026-01-27 – Rich Set of Entities & Transforms for OSINT on Telegram with Maltego
* [telegram-id](https://github.com/GabrielRF/telegram-id) ⭐ 208 | 🐛 0 | 📅 2022-02-24 – Guide on how to get Telegram IDs
* [Telegram-Archive](https://github.com/GeiserX/Telegram-Archive) ⭐ 189 | 🐛 4 | 🌐 Python | 📅 2026-08-25 – Docker-based tool for archiving Telegram channels and groups with full media support, incremental backups, and a local web viewer.
...
* [Awesome DevOps Telegram](https://github.com/palark/awesome-devops-telegram) ⭐ 292 | 🐛 0 | 📅 2026-08-24 – A curated list of Telegram channels and groups dedicated to DevOps, SRE, and Platform Engineering in English.
