...
* [OpenClaw](https://github.com/openclaw/openclaw) ⭐ 390,531 | 🐛 8,649 | 🌐 TypeScript | 📅 2026-09-26 – Self-hosted AI assistant that connects Claude to Telegram (and 7 other channels) from a single deployment. Supports hooks, plugins, and tools. Telegram setup: <https://clawdbot.blog/channels/telegram/>
...
* [Aeon](https://github.com/aeonfun/aeon) ⭐ 756 | 🐛 2 | 🌐 Shell | 📅 2026-09-24 – [Open Source](https://github.com/aeonfun/aeon) ⭐ 756 | 🐛 2 | 🌐 Shell | 📅 2026-09-24 autonomous AI agent framework, self-hosted under MIT, that reports to Telegram with interactive inline buttons and inbound command routing via webhook and long-polling.
...
* [@el\_monitorro\_bot](https://t.me/el_monitorro_bot) – is a [Open Source](https://github.com/ayrat555/el_monitorro) ⭐ 215 | 🐛 10 | 🌐 Rust | 📅 2026-07-09 high-performance feed reader as a Telegram bot. It supports RSS, Atom and JSON feeds. Written in Rust.
...
* [python-telegram-bot](https://github.com/python-telegram-bot/python-telegram-bot) ⭐ 29,491 | 🐛 29 | 🌐 Python | 📅 2026-09-23 – We have made you a wrapper you can't refuse
...
* [AIOGram](https://github.com/aiogram/aiogram) ⭐ 5,875 | 🐛 85 | 🌐 Python | 📅 2026-09-19 – A pretty simple and fully asynchronous framework for Telegram Bot API.
...
* [ErisPulse](https://github.com/ErisPulse/ErisPulse) ⭐ 57 | 🐛 1 | 🌐 Python | 📅 2026-09-25 – Async-first Python bot framework with Telegram support, unified adapter interface, and plugin system; also supports multiple other platforms.
...
* [GoyGram](https://github.com/GoyGram/GoyGram) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2026-09-25 – Unified Bot API + MTProto framework with a Rust crypto/codec core.
...
* [grammY](https://github.com/grammyjs/grammY) ⭐ 3,756 | 🐛 26 | 🌐 TypeScript | 📅 2026-08-26 – The Telegram Bot Framework. (JavaScript, Typescript, Node.js)
...
* [mtcute](https://github.com/mtcute/mtcute) ⭐ 564 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-25 – modern typescript library for mtproto
...
* [telegram-bot-ruby](https://github.com/atipugin/telegram-bot-ruby) ⭐ 1,424 | 🐛 1 | 🌐 Ruby | 📅 2026-08-25 – Ruby wrapper for Telegram's Bot API
...
* [MadeLineProto](https://github.com/danog/MadelineProto) ⭐ 3,521 | 🐛 75 | 🌐 PHP | 📅 2026-09-24 – Async PHP client/server API for the telegram MTProto protocol.
...
* [Frankenstein](https://github.com/ayrat555/frankenstein) ⭐ 372 | 🐛 12 | 🌐 Rust | 📅 2026-09-25 – Telegram bot API client for Rust.
...
* [KtGram](https://github.com/vendelieu/telegram-bot) ⭐ 249 | 🐛 5 | 🌐 Kotlin | 📅 2026-09-23 – Telegram Bot API wrapper with handy Kotlin DSL.
...
* [Telegram-Archive](https://github.com/GeiserX/Telegram-Archive) ⭐ 210 | 🐛 2 | 🌐 Python | 📅 2026-09-25 – Docker-based tool for archiving Telegram channels and groups with full media support, incremental backups, and a local web viewer.
...
* [VideoDownloaderBot](https://github.com/Avazbek22/VideoDownloaderBot) ⭐ 7 | 🐛 0 | 🌐 Python | 📅 2026-09-19 – Self-hosted Telegram bot for receiving supported media as video, original files, or MP3.
...
* [telegram-forwarder](https://github.com/awdr74100/telegram-forwarder) ⭐ 3 | 🐛 5 | 🌐 Rust | 📅 2026-09-25 – Many-to-many CLI forwarder that mirrors messages and media between chats, with per-route content filters, recovery of posts deleted at the source, and automatic FloodWait handling.
...
* [Awesome-grammY](https://github.com/grammyjs/awesome-grammY) ⭐ 282 | 🐛 7 | 📅 2026-07-27 – This is a curated list of projects that are using grammY.
